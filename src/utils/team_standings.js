...
export function groupMatchesByTournament(matches, teamName) {
...
export function buildDescription(tournamentName, isOngoing) {
...
export function formatTournamentName(pagename) {
...
export function buildRecentResults(matches, teamName) {
  if (!matches || matches.length === 0) return null;
